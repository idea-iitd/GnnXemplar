...
def main():
    parser = argparse.ArgumentParser(
        description='Minesweeper Node Classification')
    ...
    # Load the Minesweeper dataset from local files via our load_dataset branch:
    data, _, _, _ = load_dataset("minesweeper")
    data = data.to(device)
    ...
    torch.save(model.state_dict(), "data/minesweeper/model.pt")
