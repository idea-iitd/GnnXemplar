...
def main():
    parser = argparse.ArgumentParser(
        description='Questions Dataset Node Classification')
    ...
    # Load Questions dataset (local)
    data, _, _, _ = load_dataset("questions")
    data = data.to(device)

    # If masks are not available, create random splits
    ...
    torch.save(model.state_dict(), "data/questions/model.pt")
